...
1850 C(3,1)=-1:C(2,1)=-.7:C(4,1)=-.7:C(4,2)=-.7:C(5,2)=-1:C(6,2)=-.7
1860 C(1,2)=1:C(2,2)=.7:C(6,1)=.7:C(7,1)=1:C(8,1)=.7:C(8,2)=.7:C(9,2)=1
...
1920 IF R1>.9799999 THEN K3=3:K9=K9+3:GOTO 1950
1930 IF R1>.95 THEN K3=2:K9=K9+2:GOTO 1950
1940 IF R1>.8 THEN K3=1:K9=K9+1
1950 B3=0:IF RND(1)>.96 THEN B3=1:B9=B9+1
...
2090 Z4=Q1:Z5=Q2:K3=0:B3=0:S3=0:G5=0:D4=.5*RND(1):Z(Q1,Q2)=G(Q1,Q2)
...
2150 PRINT : K3=INT(G(Q1,Q2)*.01):B3=INT(G(Q1,Q2)*.1)-10*K3
...
2250 GOSUB 5460:K(I,1)=R1:K(I,2)=R2:K(I,3)=S9*(.5+RND(1)): NEXT I
...
2560 PRINT "WARP FACTOR  (0-";X$;")";: INPUT W1: IF D(1)<0 AND W1>.2 THEN 2630
...
2640 N=INT(W1*8+.5):IF E-N>=0 THEN 2720
...
2770 D(I)=D(I)+D6: IF D(I)>-.1 AND D(I)<0 THEN D(I)=-.1: GOTO 2810
...
2810 NEXT I:IF RND(1)>.2 THEN 2880
2820 R1=FNR(1):IF RND(1)>=.6 THEN 2850
