...
18 'บ                  DAILY WEIGHT RECORD "MOTIVATION" FORM                  บ
20 'บ                                                                         บ
22 'บ    The form generated by this program can be used to maintain daily or  บ
24 'บ other periodic health records.  The form is designed primarily for a    บ
26 'บ weight record; however, the word "WEIGHT" can be replaced easily by any บ
28 'บ other word or dimension for which a daily or periodic record might be   บ
30 'บ appropriate.  The form can be modified easily to increase or decrease   บ
31 'บ the number of lines by making an appropriate change in the number of    บ
32 'บ loops printed.  The loop size entry 27 and is currently set at 24 to    บ
33 'บ make the form the right length with its present format and content.     บ
34 'บ To run the form as designed, simply set print head at the first line    บ
35 'บ below the perforation and ascertain the printer is ON LINE. Press <F2>. บ
