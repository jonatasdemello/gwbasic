...
20 KEY 1,"Í>DOS":KEY 2," EXIT ":KEY 3,"PRINT":KEY 4,"":KEY 5,"":ON KEY(1) GOSUB 65100:ON KEY(2) GOSUB 65200:ON KEY(3) GOSUB 65300:FOR I=1 TO 3:KEY(I) ON:NEXT I
50 SCREEN 0,1:WIDTH 40:COLOR C1,C2,C3:CLS:COLOR 14,C3:KEY OFF:LOCATE 25,1:PRINT SPACE$(40);:KEY ON:COLOR C1,C2
200 T$(0)="  FINANCE PROGRAMS   ":GOSUB 500:GOSUB 400:X1=8:GOSUB 300:COLOR C1:I=0
201 I=I+1:T$(I)="Description 1":P$(I)="Program Name 1":GOSUB 65400
202 I=I+1:T$(I)="Description 2":P$(I)="Program Name 2":GOSUB 65400
203 I=I+1:T$(I)="Description 3":P$(I)="Program Name 3":GOSUB 65400
204 I=I+1:T$(I)="Description 4":P$(I)="Program Name 4":GOSUB 65400
205 I=I+1:T$(I)="Description 5":P$(I)="Program Name 5":GOSUB 65400
206 I=I+1:T$(I)="Description 6":P$(I)="Program Name 6":GOSUB 65400
207 I=I+1:T$(I)="Description 7":P$(I)="Program Name 7":GOSUB 65400
208 I=I+1:T$(I)="Description 8":P$(I)="Program Name 8":GOSUB 65400
209 I=I+1:T$(I)="Menu of Graphics Programs":P$(I)="MENUB":GOSUB 65400
