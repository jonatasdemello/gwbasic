...
690 GOSUB 1125
695 IF ZMNO%<13 THEN ZPD$=" " :ELSE ZPD$=""
...
715 ZL=1:ZH=ZMNO%-1:Z$=ZSAVE$:Z=13:GOSUB 100
...
765 ZCOL%=LEN(ZFLD$):IF ZMNO%<13 THEN ZPD$=" " :ELSE ZPD$=""
...
950 LOCATE 13,32,0:PRINT "VARPTR";STRING$(17,"SOUND");"COLOR"
...
9100 CLS:LOCATE 13,1,0:PRINT TAB(32);"Memory Statistics":PRINT:PRINT TAB(27);"Remaining Memory:  ";FRE(0):PRINT:PRINT TAB(27);"Program Length:    ";61529!-FRE(0):RETURN
